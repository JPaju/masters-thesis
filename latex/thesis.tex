...
\newcommand{\inlinescala}[1]{\mintinline{scala}{#1}}
\newcommand{\inlinehaskell}[1]{\mintinline{haskell}{#1}}
...
\input{chapters/c3-zio.tex}
\input{chapters/c4-case-description.tex}
